...
if __name__ == '__main__':
    ...
    print('DLINW1: ', isclose(encoder.debug['DLINW1'], np.einsum(f"{dict(layouts)['LINW1']}->UI", dlinear1_w)))

    print('DLINB2: ', isclose(encoder.debug['DLINB2'], dlinear2_b))

    print('DLINW2: ', isclose(encoder.debug['DLINW2'], np.einsum(f"{dict(layouts)['LINW2']}->IU", dlinear2_w)))
